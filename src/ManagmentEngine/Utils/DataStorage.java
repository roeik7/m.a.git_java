...
public abstract class DataStorage {
    ...
    static protected void initialize_sha1() throws NoSuchAlgorithmException {
        digest = MessageDigest.getInstance("SHA-1");
        digest.reset();
    }

    abstract public void create_local_file(DataStorage node, String path);
    ...
    static protected String get_sha1(String content) throws UnsupportedEncodingException, NoSuchAlgorithmException {
    ...
    static protected Date string_to_date(String lastUpdateDate) throws ParseException {
        Date date1=new SimpleDateFormat("dd.MM.yyyy-HH:mm:ss:SSS").parse(lastUpdateDate);
